...
var Engine = (function(global) {
    ...
    function render() {
        ...
        var rowImages = [
            ...
            numCols = 7,
            row, col;
        var boatImages = 'images/boat.png';
        ...
        if (currentLevel === 0) {
                    ...
                    switch (currentLevel) {
                        case 1:
                            ...
                            setTimeout(function() {
                                ...
                                document.getElementById("level").style.textDecoration = "underline";
                            }, 50);
                            setTimeout(function() {
                                document.getElementById("nextlevel").hidden = true;
                                document.getElementById("level").style.color = "black";
                                document.getElementById("level").style.textDecoration = "none";
                            }, 2000);
                            break;
                        case 2:
                            document.getElementById("level").innerHTML = "Level: Difficult";
                            currentLevel += 1;
            ...
            ctx.drawImage(Resources.get(boatImages), 610, 50);
            renderEntities();
        } else {
            document.getElementById("menu").hidden = true;
            document.getElementById("menu2").hidden = true;
